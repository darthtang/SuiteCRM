 ...
 * PLACE ANY CUSTOMIZATIONS IN pls12_DarrensPerson
 */

require_once('include/SugarObjects/templates/person/Person.php');

class pls12_DarrensPerson_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'pls12_DarrensPerson';
	var $object_name = 'pls12_DarrensPerson';
	var $table_name = 'pls12_darrensperson';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function pls12_DarrensPerson_sugar(){	
		parent::Person();
	}
